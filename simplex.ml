...
let a1 = [| [| -3 ; -4 ; -2 ; -5 ; 10 |] ; [| 2 ; 3 ; 4 ; 1 ; 2 |] ; [| -4 ; -2 ; 4 ; 1 ; -1 |] ; [| 0 ; 1 ; 0 ; -1 ; 0 |] |]
let b1 = [| 0 ; 20 ; 5 ; -10 |]
let frac_a1 = matrix_foi a1
let frac_b1 = array_foi b1
let k1 = 3
let l1 = 4

let x = simplex frac_a1 frac_b1 k1 l1

let () = print_string "The result is : " ; print_frac x

(* let a1 = [|[| div (foi (-1)) (foi 3) ; foi (-4) ; foi (-2) ; foi (-5) ; foi(-10) |] ; [|foi 2 ; foi 3 ; foi 4 ; foi 1 ; foi 2|] ; [|foi (-4) ; foi (-2) ; foi 4 ; foi 1 ; foi (-1)|] ; [| foi 0 ; foi 1 ; foi 0 ; foi (-1) ; foi 0|]|]
let b1 = [| foi 0 ; foi 20 ; foi (5) ; foi (-10) |]
let k1 = 3
let l1 = 4
